...
\newcommand{\dropoutnetwork}[1]{
    \draw [fill=#1!10, rounded corners] (-0.75, -0.25) rectangle (1.75, 1.75);
...
\tikzstyle{io mini} = [neuron mini, fill=yellow!20]
\tikzstyle{neuron} = [draw, minimum width=5mm, minimum height=5mm, thick, rectangle, rounded corners, inner sep=0pt, fill=red!20]
\tikzstyle{neuron mini} = [draw, minimum width=2mm, minimum height=2mm, circle, inner sep=0pt, fill=red!20]
...
\includeonly{sections/regularization}
